function displaySpectators(){
  ...
  if(request.status==200){
    for(let i = 0; i < data.participants.length; i++){
      ...
      res = "";
      /*Champion*/
      res += '<td><img src="DATA/'+dataDragonVersion+'/img/champion/'+chIdToName(data.participants[i].championId)+'.png" alt="'+chIdToName(data.participants[i].championId)+'" class="teamChampionPic">'+chIdToName(data.participants[i].championId)+'</td>';
      /*Nom*/
      ...
      /*Summoner Spells*/
      res += '<td><img src="DATA/'+dataDragonVersion+'/img/spell/'+idToSummonerSpell(data.participants[i].spell1Id)+'.png" class="SummonerSpell" alt="Summoner Spell"><img src="DATA/'+dataDragonVersion+'/img/spell/'+idToSummonerSpell(data.participants[i].spell2Id)+'.png" class="SummonerSpell" alt="Summoner Spell"></td>'
